...
from leave.views import (
    AdminAssignLeaveAPIView,
    AdminLeaveAPIView,
    AdminLeaveTypeAPIView,
    EmployeeLeaveAPIView,
    LeaveBalanceSummaryAPIView,
)

from . import models, views

urlpatterns = [
    # leave urls start here ##
    path(
        "balance-summary/",
        LeaveBalanceSummaryAPIView.as_view(),
        name="leave-balance-summary",
    ),
    path(
        "admin/assign-leave/",
        AdminAssignLeaveAPIView.as_view(),
        name="admin-assign-leave",
    ),
    path(
        "leaves/",
        EmployeeLeaveAPIView.as_view(),
        name="employee-leave-list-create",
    ),
    path(
        "leaves/<int:pk>/",
        EmployeeLeaveAPIView.as_view(),
        name="employee-leave-update-delete",
    ),
    # 🛠 Admin leave APIs
    path(
        "admin/leaves/",
        AdminLeaveAPIView.as_view(),
    ...
    # Rotating Work Type Assignment API endpoints (no 'api/' prefix)
    path(
        "employee/assign-rotating-work-type/",
        views.assign_rotating_work_type,
        name="assign-rotating-work-type",
    ),
    path(
        "employee/assign-rotating-work-type/get/",
        views.get_rotating_work_type,
        name="get-rotating-work-type",
    ),
    path(
        "employee/assign-rotating-work-type/<int:assignment_id>/",
        views.update_rotating_work_type,
        name="update-rotating-work-type",
    ),
    path(
        "employee/assign-rotating-work-type/<int:assignment_id>/delete/",
        views.delete_rotating_work_type,
        name="delete-rotating-work-type",
    ),
    path(
        "admin/leavetype/",
        AdminLeaveTypeAPIView.as_view(),
        name="admin creating leave type",
    ),
    path(
        "admin/leavetype/<int:pk>/",
        AdminLeaveTypeAPIView.as_view(),
        name="admin update and delete leave type",
    ),
