...
# ─── ACE Assessment Platform Integration ───────────────────────────
# URL of the ACE test platform backend API (used for auto-creating
# test candidates when stage_type='test' in recruitment pipeline)
ACE_API_BASE_URL = env("ACE_API_BASE_URL", default="http://localhost:8001/api")
ACE_API_TIMEOUT = env.int("ACE_API_TIMEOUT", default=15)
