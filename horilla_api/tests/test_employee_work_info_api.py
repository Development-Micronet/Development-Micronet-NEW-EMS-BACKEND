...
class EmployeeWorkInfoAPITest(TestCase):
    ...
    def test_work_info_list_returns_json_even_when_browser_accept_header_is_used(self):
        admin_user = User.objects.create_superuser(
            username="workinfoadmin",
            password="password",
            email="workinfoadmin@example.com",
        )
        employee = Employee.objects.create(
            employee_first_name="List",
        ...
        response = self.client.get(
            "/api/employee/employee-work-information/", HTTP_ACCEPT="text/html"
        )
    ...
    def test_work_info_invalid_page_returns_json_error_response(self):
        admin_user = User.objects.create_superuser(
            username="workinfopageadmin",
            password="password",
            email="workinfopageadmin@example.com",
        )
        employee = Employee.objects.create(
            employee_first_name="Paged",
        ...
        self.client.force_authenticate(user=admin_user)
        response = self.client.get(
            "/api/employee/employee-work-information/?page=999",
