...
from . import views
from .views import (
    ProjectNewCreateAPIView,
    ProjectNewStageAPIView,
    Taskemployee,
    TaskNewAPIView,
    TimeSheetEmployeeAPIView,
    TimeSheetNewAPIView,
)
...
urlpatterns = [
    ...
    path(
        "timesheets-new/",
        TimeSheetNewAPIView.as_view(),
        name="timesheet-new-list-create",
    ),
    path(
        "timesheets-new/<int:pk>/",
        TimeSheetNewAPIView.as_view(),
        name="timesheet-new-detail",
    ),
    path(
        "timesheets-assigned/",
        TimeSheetEmployeeAPIView.as_view(),
        name="timesheet-new-detail",
    ),
    # Task api here
    path("tasks-assigned/", Taskemployee.as_view(), name="tasks-asigned"),
    path("tasks-new/", TaskNewAPIView.as_view(), name="task-new-list-create"),
    path("tasks-new/<int:pk>/", TaskNewAPIView.as_view(), name="task-new-detail"),
    # Get
    path(
        "projects-new/",
        ProjectNewCreateAPIView.as_view(),
        name="project-new-list",
    ),
    # project update
    path(
        "projects-new/<int:pk>/",
    ...
    # ProjectNewStage endpoints
    path(
        "project-stages/",
        ProjectNewStageAPIView.as_view(),
        name="project-stage-list-create",
    ),
    path(
